...
class MainViewPagerAdapter(fragmentManager: FragmentManager): FragmentStatePagerAdapter(fragmentManager) {
    ...
    private val fragments = arrayOf(HomeFragment.newInstance(), AsteroidFragment.newInstance(), EarthFragment.newInstance(), SettingFragment.newInstance(), SettingFragment.newInstance())
